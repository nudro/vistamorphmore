#!/usr/bin/env bash
# VMM/Diffusion_B_VMM_Github on Data/FLIR_VMM/Severe — small-N curriculum
...
export DATA_ROOT="${DATA_ROOT:-${REPO_ROOT}/Data/FLIR_VMM/Severe}"
export EXPERIMENT="${EXPERIMENT:-diffusion_b_flir_severe_p1_50_reg_100}"
