#!/usr/bin/env bash
# VMM/Diffusion_B_VMM_Github on Data/FLIR_VMM/Moderate — small-N curriculum
# Phase 1 (epochs 0-49):  DDPM + LPIPS_A + struct-B (ld trains)
# Phase 2 (epochs 50-99): ld frozen; STN reg aligns/registers
set -euo pipefail
...
export DATA_ROOT="${DATA_ROOT:-${REPO_ROOT}/Data/FLIR_VMM/Moderate}"
export EXPERIMENT="${EXPERIMENT:-diffusion_b_flir_moderate_p1_50_reg_100}"
