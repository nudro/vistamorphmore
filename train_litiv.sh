#!/usr/bin/env bash
# VMM/Diffusion_B_VMM_Github on Data/LITIV_2018_paired — small-N curriculum
...
export DATA_ROOT="${DATA_ROOT:-${REPO_ROOT}/Data/LITIV_2018_paired}"
export EXPERIMENT="${EXPERIMENT:-diffusion_b_litiv_p1_50_reg_100}"
