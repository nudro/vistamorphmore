#!/usr/bin/env bash
# VMM/Diffusion_B_VMM_Github on Data/FLIR_VMM/Mild — small-N curriculum
...
export DATA_ROOT="${DATA_ROOT:-${REPO_ROOT}/Data/FLIR_VMM/Mild}"
export EXPERIMENT="${EXPERIMENT:-diffusion_b_flir_mild_p1_50_reg_100}"
